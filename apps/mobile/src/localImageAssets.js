...
const bundledCardImages = {
  ...
  "opposites": {
    "big": require("../assets/photos/opposites/big.png"),
    "cold": require("../assets/photos/opposites/cold.png"),
    "empty": require("../assets/photos/opposites/empty.png"),
    "fast": require("../assets/photos/opposites/fast.png"),
    "full": require("../assets/photos/opposites/full.png"),
    "hard": require("../assets/photos/opposites/hard.png"),
    "heavy": require("../assets/photos/opposites/heavy.png"),
    "hot": require("../assets/photos/opposites/hot.png"),
    "light": require("../assets/photos/opposites/light.png"),
    "long": require("../assets/photos/opposites/long.png"),
    "narrow": require("../assets/photos/opposites/narrow.png"),
    "short": require("../assets/photos/opposites/short.png"),
    "slow": require("../assets/photos/opposites/slow.png"),
    "small": require("../assets/photos/opposites/small.png"),
    "soft": require("../assets/photos/opposites/soft.png"),
    "tall": require("../assets/photos/opposites/tall.png"),
    "thick": require("../assets/photos/opposites/thick.png"),
    "thin": require("../assets/photos/opposites/thin.png"),
    "wide": require("../assets/photos/opposites/wide.png"),
  },
  "shapes": {
  ...
  "titles": {
    "alphabet": require("../assets/photos/titles/alphabet.png"),
    "birds": require("../assets/photos/titles/birds.png"),
    "body": require("../assets/photos/titles/body.png"),
    "colors": require("../assets/photos/titles/colors.png"),
    "fruits": require("../assets/photos/titles/fruits.png"),
    "indian_food": require("../assets/photos/titles/indian_food.png"),
    "numbers": require("../assets/photos/titles/numbers.png"),
    "opposites": require("../assets/photos/titles/opposites.png"),
    "shapes": require("../assets/photos/titles/shapes.png"),
    "vegetables": require("../assets/photos/titles/vegetables.png"),
    "vehicles": require("../assets/photos/titles/vehicles.png"),
    "wild_animals": require("../assets/photos/titles/wild_animals.png"),
  },
  "vegetables": {
