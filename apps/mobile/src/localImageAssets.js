...
const bundledCardImages = {
  "alphabet": {
    "a": require("../assets/photos/letters/apple.png"),
    "b": require("../assets/photos/letters/ball.png"),
    "c": require("../assets/photos/letters/cat.png"),
    "d": require("../assets/photos/letters/dog.png"),
    "e": require("../assets/photos/letters/elephant.png"),
    "f": require("../assets/photos/letters/fish.png"),
    "g": require("../assets/photos/letters/giraffe.png"),
    "h": require("../assets/photos/letters/house.png"),
    "i": require("../assets/photos/letters/ice-cream.png"),
    "j": require("../assets/photos/letters/juice.png"),
    "k": require("../assets/photos/letters/kite.png"),
    "l": require("../assets/photos/letters/lion.png"),
    "m": require("../assets/photos/letters/moon.png"),
    "n": require("../assets/photos/letters/nest.png"),
    "o": require("../assets/photos/letters/orange.png"),
    "p": require("../assets/photos/letters/penguin.png"),
    "q": require("../assets/photos/letters/queen.png"),
    "r": require("../assets/photos/letters/rainbow.png"),
    "s": require("../assets/photos/letters/sun.png"),
    "t": require("../assets/photos/letters/tiger.png"),
    "u": require("../assets/photos/letters/umbrella.png"),
    "v": require("../assets/photos/letters/violin.png"),
    "w": require("../assets/photos/letters/whale.png"),
    "x": require("../assets/photos/letters/xylophone.png"),
    "y": require("../assets/photos/letters/yoyo.png"),
    "z": require("../assets/photos/letters/zebra.png"),
  },
  "numbers": {
    "1": require("../assets/photos/numbers/one.png"),
    "2": require("../assets/photos/numbers/two.png"),
    "3": require("../assets/photos/numbers/three.png"),
    "4": require("../assets/photos/numbers/four.png"),
    "5": require("../assets/photos/numbers/five.png"),
    "6": require("../assets/photos/numbers/six.png"),
    "7": require("../assets/photos/numbers/seven.png"),
    "8": require("../assets/photos/numbers/eight.png"),
    "9": require("../assets/photos/numbers/nine.png"),
    "10": require("../assets/photos/numbers/ten.png"),
  },
  "birds": {
